...
import { Search, Scale, TrendingUp, Heart, Activity, Usb, Settings, Zap, Wifi } from "lucide-react"
                ...
                <>
                  <div>
                    ...
                    <p className="font-semibold text-orange-600">
                      {calculateProjectedExitDate(selectedAnimal.pesoAtual, getLastGMD(selectedAnimal.historicoPeso))}
                    </p>
                  </div>
          ...
          {selectedAnimal.sexo === "F" && (
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                {(selectedAnimal.statusReprodutivo === "bezerra" || selectedAnimal.statusReprodutivo === "novilha") && (
